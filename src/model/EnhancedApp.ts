...
export class EnhancedApp {
    ...
    public constructor(service: EnhancedService, resource: AppResource) {
        ...
        this._activeDeployment = this.initActiveDeployment();
    }
    ...
    get activeDeployment(): Promise<EnhancedDeployment | undefined> {
    ...
    private async initActiveDeployment(): Promise<EnhancedDeployment | undefined> {
        this._activeDeployment = Promise.resolve(undefined);
        ...
        for await (const deploymentResource of deploymentResources) {
            if (deploymentResource.properties?.active) {
                this._activeDeployment = Promise.resolve(new EnhancedDeployment(this, deploymentResource));
                break;
            }
        }
        return this._activeDeployment;
