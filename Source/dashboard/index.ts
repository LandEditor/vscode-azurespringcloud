...
export async function initialize(
	...
	if (dashboardExt) {
		...
		// register commands
		registerCommandWithTreeNodeUnwrapping(
			"azureSpringApps.app.showLiveInformation",
			async (_context: IActionContext, appNode: AppItem) => {
...
class AzureSpringAppsProvider implements RemoteBootAppDataProvider {
	...
	public toRemoteBootAppData(
		appNode: AppItem
	): RemoteBootAppData | undefined {
		const app = appNode.app;
